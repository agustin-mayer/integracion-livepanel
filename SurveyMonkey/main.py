...
def main():
    ...
    if project_state != "ERROR_INITIALIZING":
        #Si el proyecto se rebota desde el servidor se borra
        project_state = livepanel_manager.enqueue_project_for_processing(project_id) 
